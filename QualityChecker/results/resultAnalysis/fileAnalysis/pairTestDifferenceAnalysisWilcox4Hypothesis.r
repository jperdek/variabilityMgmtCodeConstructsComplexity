...
fifthFormData <<- read.csv('../forms/form5/generalAGGREGATETYPHONE_FORM5.csv', sep=";")
...
write.table(finalWilcoxTest, ".\\fileAnalysis\\pairedTestForm5-1.csv", row.names=FALSE, dec=",", sep=";")
